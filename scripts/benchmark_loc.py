...
krom math import radians, cos, sin, asin, sqrt
...
class LaunchManager:
    ...
    def start(self):
        ...
        for _ in range(5):
            ...
            time.sleep(5)
            bag = subprocess.Popen(["rosbag play " + self.bag_path_],
                                 shell=True,preexec_fn=os.setsid)
            ...
            lock.acquire()
            print('DONE')
            run = {'gps': gps_hist, 'loc': loc_hist, 'start': 0, 'scale': scale}
...
class BenchmarkLoc:
    def __init__(self):
        ...
        self.sem_log_sub_ = rospy.Subscriber('/subt/sem_pose', PoseWithCovarianceStamped, self.sem_loc_cb)
...
if __name__ == '__main__':
    ...
    #lm = LaunchManager('/media/ian/SSD1/tmp_datasets/KITTI/kitti2.bag')
    #lm = LaunchManager('/media/ian/SSD1/tmp_datasets/KITTI/kitti9.bag')
